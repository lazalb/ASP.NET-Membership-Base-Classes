...
namespace MembershipBase
{
	...
	/// and methods that are marked as abstract in RoleProvider.
	/// </summary>
	internal abstract class RoleProviderBase : RoleProvider
	{

		#region RoleProvider Abstract Properties
		...
		#region RoleProvider Abstract Methods
